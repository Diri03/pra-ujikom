                ...
                <form action="{{ route('order.store') }}" method="post" class="row needs-validation" novalidate>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="order_note" id="note" cols="30" rows="5" class="form-control"></textarea>
                        </div>
                    </div>
...
<script>
    ...
    addRow.addEventListener('click', (e)=>{
        ...
        tr.innerHTML = `
            ...
            <td><input type="number" class="qtys" step="any" min="1" name="qty[]" class="form-control" value="1"></td>
